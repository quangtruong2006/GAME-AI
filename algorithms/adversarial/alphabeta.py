# GAME-AI/algorithms/adversarial/alphabeta.py

def alphabeta(gamestate, depth, alpha, beta, is_maximizing, is_p1_perspective):
    ...
    for action in actions:
        ...
        score, _ = alphabeta(sim, depth - 1, alpha, beta, not is_maximizing, is_p1_perspective)
